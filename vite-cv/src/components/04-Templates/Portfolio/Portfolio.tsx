    ...
    return (
        <section id={"portfolio"} className={style.container}>
            ...
            <div className={style.projects}>
                ...
                <a href={"https://movielook.mtlk.fr"} title={"MovieLook"} className={style.project} target={"_blank"}
                   rel={"noreferrer"}>
                ...
                <a href={"https://stlogiks.fr"} title={"ST Logiks project"} className={style.project} target={"_blank"}
                   rel={"noreferrer"}>
